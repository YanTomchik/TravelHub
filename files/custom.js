...
$(function () {
    ...
    $('#kt_header_user_menu_toggle, #kt_header_mobile_user_menu_toggle').on('click', function () {
    ...
    var body = $('body');
    body.on('click', '.conference-view', function (e) {
        var modalBlock, modalBlockBodyClass, url;
        modalBlock = $('#conferenceView');
        modalBlockBodyClass = '#conferenceView .modal-conf';
        url = '/conferences/view/' + $(this).data('id');
    ...
    body.on('click', '.conference-offer', function (e) {
        var modalBlock = $('#conferenceOffer');

        $('.conference-title').text($(this).data('title'));
        $('#conference-hidden-id').val($(this).data('id'));
