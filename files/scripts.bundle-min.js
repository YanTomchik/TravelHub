...
(function ($) {
    ...
    $.fn[pluginName].defaults = {
        ...
        translate: {
            records: {
                processing: MAIN_LANGUAGE === 'en' ? 'Loading...' : 'Загрузка...',
                noRecords: MAIN_LANGUAGE === 'en' ? 'Not record yet' : 'Нет записей',
            },
            toolbar: {
                pagination: {
                    items: {
                        default: {
                            first: MAIN_LANGUAGE === 'en' ? 'First' : 'Первая',
                            prev: MAIN_LANGUAGE === 'en' ? 'Previous' : 'Предыдущая',
                            next: MAIN_LANGUAGE === 'en' ? 'Next' : 'Следующая',
                            last: MAIN_LANGUAGE === 'en' ? 'Last' : 'Последняя',
                            more: MAIN_LANGUAGE === 'en' ? 'More pages' : 'Больше страниц',
                            input: MAIN_LANGUAGE === 'en' ? 'Number of page' : 'Номер страницы',
                            select: MAIN_LANGUAGE === 'en' ? 'Select number of page' : 'Выберите номер страницы',
                            all: MAIN_LANGUAGE === 'en' ? 'all' : 'все',
                        },
                        info: MAIN_LANGUAGE === 'en' ? 'Show {{start}} - {{end}} from {{total}}' : 'Показано {{start}} - {{end}} из {{total}}',
                    },
                },
            },
        },
...
var KTLayoutQuickUser = function () {
    ...
    var _init = function () {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            toggleBy: ['kt_quick_user_toggle', 'kt_mobile_quick_user_toggle']
        });
...
var KTLayoutQuickNotifications = function () {
    ...
    var _init = function () {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            toggleBy: ['kt_quick_notifications_toggle', 'kt_mobile_quick_notification_toggle']
        });
