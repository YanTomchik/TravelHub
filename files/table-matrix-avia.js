document.addEventListener('DOMContentLoaded', async () => {
    let currentStartDate = new Date('2024-08-01');  // Example start date
    let currentEndDate = new Date('2024-08-08');    // Example end date
    ...
    async function fetchData() {
        ...
        const apiUrl = `https://api.travelhub.by/flight/comparison-table?route=trip&locationFrom=MSQ&locationTo=MOW&adults=1&period=${dateFromFetch};${dateToFetch}&currency=${USER_CURRENCY}`;
